...
ggplot(PeterPaul.chem.nutrients, aes(x=sampledate, y=temperature_C)) +
  ...
  scale_x_date(date_breks="5 years", date_lables = "%Y") 
...
ggplot(EPAair, aes(x=PM2.5, y=Ozone)) +
  geom_point(aes(color=EPAair$meanLatitude), alpha = 0.5) +
...
ggplot(EPAair, aes(x=Month, y= PM2.5, color=Yeat))+
  geom_point() +
  scale_x_continuous()
