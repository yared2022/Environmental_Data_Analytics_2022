...
huc8_sf_subset <- st_read('./Data/Spatial/NCHUC8.shp') %>% 
...
geom_sf(data=huc8_sf, fill= 'purple')
...
wind_raw <- read_csv('https://raw.githubusercontent.com/ENV859/EnviroAtlasData/main/Wind_Energy.csv', 
...
huc2_sf <- counties_sf %>% 
  group_by('STATEFP') %>% 
  summarize(DWQ_Basin = sum(DWQ_Basin))
