...
head(NTL.phys.data1999)
nrow(NTL.phys.data1999)

# Exercise: 
# filter NTL.phys.data for Tuesday Lake from 1990 through 1999.
NTL.phys.data.TL <- filter(NTL.phys.data, lakename == "Tuesday Lake" & (year4>=1990 & year4<=1999))
tail(NTL.phys.data.TL)
```
