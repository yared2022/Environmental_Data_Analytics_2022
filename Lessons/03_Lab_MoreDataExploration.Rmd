...
```{r}
hightempforecastF <- c(31,40,35,45,50,53,40,31,50,55)
lowtempforecastF <- c(13,14,15,15,15,15,14,13,15,15)
...
```{r}
#higtempforecastC <- c(31,40,35,45,50,53,40,31,50,55)
temp_convF_C <- function(tempF) 
{
  tempC = tempF * (5/9)+32
  return(tempC)
}
hightempforecastC <- temp_convF_C(hightempforecastF)
hightempforecastC

lowtempforecastC <- temp_convF_C(lowtempforecastF)
lowtempforecastC
```
